...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="web/index2.html" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>A</b>LT</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Admin</b>ELK@</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
        	<li><a href="{{url('client')}}"><i class="fa fa-home"></i> <span>dashboard</span></a></li>
          </a>
         
        </li>
        <li class="treeview">
        	<li><a href="{{url('client/create')}}"><i class="fa fa-edit"></i> <span>Tambah Client</span></a></li>
          </a>
         
        </li>
        <li class="treeview">
          <li><a href="{{url('referral')}}"><i class=" fa fa-credit-card"></i> <span>Referral</span></a></li>
          </a>
         
        </li>
        <li class="treeview">
          <li><a href="{{url('tagihan')}}"><i class=" fa fa-credit-card"></i> <span>Tagihan</span></a></li>
          </a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <a href="https://elkanet.site">Elkanet App</a>.</strong> All rights
    reserved.
  </footer>
